  ...
  return (
    <div className="instructors">
      ...
      <div className="instructors-bio">
        ...
        <p>Nacho Mena, 2nd Dan Aikikai, is an instructor at NYEA; he began Aikido in 1996 with Coryl Crane Shihan, a student of Kazuo Chiba Shihan, 8th Dan.  Nacho is a molecular virologist, and also holds a 4th Dan in Judo.</p>
        <br/>
        <img src={elizabeth} alt="Elizabeth" />
        <div style={{textAlign:"center", marginTop:"10px"}}>
          <p><b>Elizabeth Stevens</b></p>
          <p>Instructor: Adults & Children</p>    
        </div>
        <p>Elizabeth Stevens, 1st Dan Aikikai, is an instructor at NYEA; she began Aikido in 2011 with Yamazaki Sensei.  Elizabeth is also an accomplished educator at a prestigious private school in NYC.</p>
      </div>
    </div>
  )
}
